        ...
        <AlertDialogOverlay backdropFilter='auto' backdropInvert='15%' backdropBlur='2px'>
          <AlertDialogContent bgColor='bg-modal'>
            <AlertDialogHeader fontSize='lg' fontWeight='bold'>
              👋 Thanks for trying ResumeEnhancerGPT.
            </AlertDialogHeader>

            <AlertDialogBody textAlign='center'>
              <Text>
                You have <Code>{credits}</Code> free Resume Enhancer {credits === 1 ? 'credit' : 'credits'} left.
              </Text>
              <Text mt={4}>
                {!isUsingLn ? (
                  <>
                  ...
                  <>After, just pay a small fee per Resume and cover letter with your lightning ⚡️ wallet. </>
                )}
              </Text>
            </AlertDialogBody>
    ...
    <AlertDialog isOpen={isOpen} leastDestructiveRef={cancelRef} onClose={onClose}>
      <AlertDialogOverlay backdropFilter='auto' backdropInvert='15%' backdropBlur='2px'>
        <AlertDialogContent bgColor='bg-modal'>
          ...
          <AlertDialogBody>
            Delete the job and all its Resumes and cover letters?
            <br />
