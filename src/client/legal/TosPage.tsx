    ...
    <BorderBox>
      <VStack maxW='4xl' mx='auto' p={6} spacing={6} align='flex-start'>
        ...
        <Text>
          ResumeEnhancerGPT
          <br />
          Rua Exemplo, 123, São Paulo, SP, Brazil
          <br />
      ...
      <LegalSection title='2. Description of Service'>
        <Text>
          ResumeEnhancerGPT is a SaaS application that uses AI technology to assist users in creating personalized resume and cover letter examples based on their curriculum vitae (CV) and job descriptions. The service is provided from Brazil and is subject to Brazilian law.
        </Text>
      </LegalSection>

      <LegalSection title='3. Contract Formation'>
        <Text>
          By registering for our service, you enter into a legally binding contract with ResumeEnhancerGPT under Brazilian law. The contract is formed when we confirm your registration via email.
        </Text>
      </LegalSection>

      <LegalSection title='4. User Account and Data Protection'>
        <Text>
          To use ResumeEnhancerGPT, you must register for an account and provide accurate and complete information. You are responsible for maintaining the confidentiality of your account and password. Data protection is governed by the Brazilian General Data Protection Law (LGPD).
        </Text>
      </LegalSection>

      <LegalSection title='5. Prices and Payment Terms'>
        <Text>
          Prices are displayed in your local currency where available, with BRL being our base currency. 
          All prices include applicable taxes as required by Brazilian law. Charges for our services 
        ...
        <UnorderedList mt={2} spacing={2} pl={5}>
          ...
          <ListItem>
            For Brazilian customers, prices include applicable taxes
          </ListItem>
          <ListItem>
            For international customers, additional taxes may apply according to local regulations
          </ListItem>
        </UnorderedList>
      </LegalSection>
      ...
      <LegalSection title='6. Right of Withdrawal and Withdrawal Form'>
        <VStack spacing={6} align='stretch'>
          <Box>
            <Text>
              As a consumer in Brazil, you have the right to withdraw from this contract within 7 days of purchase, in accordance with Article 49 of the Brazilian Consumer Protection Code (Código de Defesa do Consumidor). The withdrawal period expires after 7 days from the day of contract conclusion.
            </Text>
            
            <Text mt={4}>
              To exercise your right of withdrawal, you must inform us of your decision to withdraw from this contract by an unequivocal statement (e.g., a letter sent by post or email). You may use the model withdrawal form provided below, but it is not obligatory.
            </Text>
            ...
            <Text mt={4}>
              Effects of withdrawal: If you withdraw from this contract, we shall reimburse to you all payments received from you, without undue delay and in any event not later than 14 days from the day on which we are informed about your decision to withdraw from this contract.
            </Text>
          </Box>
          ...
          <Box p={4} borderWidth={1} borderRadius='lg' bg='bg-contrast-sm'>
            ...
            <VStack align='stretch' spacing={4} color='text-contrast-lg'>
              <Box>
                ...
                <Text>ResumeEnhancerGPT</Text>
                <Text>Rua Exemplo, 123, São Paulo, SP, Brazil</Text>
                <Text>Email: griesangeduardo1@gmail.com</Text>
              </Box>

              <Text>
                I/We (*) hereby give notice that I/We (*) withdraw from my/our (*) contract 
                for the provision of the following service: ResumeEnhancerGPT subscription.
              </Text>
      ...
      <LegalSection title='7. Dispute Resolution'>
        <Text>
          Any disputes arising from the use of our service shall be resolved in accordance with Brazilian law. Consumers may also contact the Brazilian consumer protection agency (Procon) for assistance.
        </Text>
      </LegalSection>

      <LegalSection title='8. Governing Law'>
        <Text>
          These Terms are governed by the laws of Brazil. The application of the UN Convention on Contracts for the International Sale of Goods is excluded.
        </Text>
      </LegalSection>

        <LegalSection title='9. Service Usage and Limitations'>
          <Text>
            ResumeEnhancerGPT provides AI-assisted cover letter and Resumes generation services. Users 
        ...
        <LegalSection title='11. Intellectual Property'>
          <UnorderedList spacing={2} pl={5}>
            <ListItem>
              ...
              remains the exclusive property of ResumeEnhancerGPT.
            </ListItem>
            <ListItem>
        ...
        <LegalSection title="12. Security">
          <Text>
            ResumeEnhancerGPT does not process any order payments directly through the website. 
