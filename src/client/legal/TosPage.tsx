    ...
    <BorderBox>
      <VStack maxW='4xl' mx='auto' p={6} spacing={6} align='flex-start'>
        ...
        <LegalSection title='2. Description of Service'>
          <Text>
            ResumeEnhancerGPT is a SaaS application that uses AI technology to assist users in creating personalized cover letter examples based on their curriculum vitae (CV) and job descriptions. The service is provided from
        ...
        <LegalSection title='4. User Account and Data Protection'>
          <Text>To use ResumeEnhancerGPT, you must register for an account and provide accurate and complete information. You are responsible for maintaining the confidentiality of your account and password.</Text>
        </LegalSection>
